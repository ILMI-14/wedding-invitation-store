...
function renderProducts(productsToShow = products) {
    ...
    if (productsToShow.length === 0) {
        invitationGrid.innerHTML = '<div style="grid-column: 1/-1; text-align: center; padding: 40px;">Tidak ada produk yang ditemukan</div>';
        return;
    }
            ...
            <div class="card-content">
                ...
                <div class="card-footer">
                    ...
                    <div class="card-action">
                        <button class="card-action button btn-view" onclick="openProductModal(${product.id})">Lihat</button>
                        <button class="card-action button btn-add" onclick="quickAddToCart(${product.id})">+</button>
                    </div>
                </div>
            </div>
        `;
...
function updateCart() {
    ...
    if (cart.length === 0) {
        cartItemsList.innerHTML = '<p style="text-align: center; padding: 40px; color: #999;">Keranjang belanja Anda kosong</p>';
    } else {
            ...
            <div class="cart-item">
                ...
                <div class="cart-item-info">
                    ...
                    <div class="cart-item-qty">
                        <button onclick="updateCartQty(${index}, -1)" style="border: none; background: none; cursor: pointer;">-</button>
